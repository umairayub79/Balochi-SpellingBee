...
const Keypad = ({ letters, onEnter, onDelete, onChar }) => {
  ...
  return (
    <div className="grid grid-cols-3 grid-rows-3 gap-4 select-none">
      ...
      <button className='bg-red-500 hover:bg-red-600 rounded-lg p-4 text-gray-100 font-bold text-2xl outline-none' onClick={onDelete}>
      ...
      <button className='bg-yellow-500 hover:bg-yellow-600 rounded-lg p-4 text-gray-100 font-bold text-2xl outline-none' onClick={onShuffle}>
      ...
      <button className='bg-green-500 hover:bg-green-600 rounded-lg p-4 text-gray-100 font-bold text-2xl outline-none' onClick={onEnter}>
